    ...
    <div id="block">
        ...
        <section id="about">
            <div>
                <h1>About Us</h1>
                <p>
                    Simple Bus Ticket Booking System mainly focus on online ticket reservation and route management. The system displays the list of available routes according to their prices.
                    </p>
            </div>
        </section>
        <section id="contact">
